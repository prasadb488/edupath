...
const Navbar = () => {
  ...
  <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#e7edf3] px-10 py-3">
          <div className="flex items-center gap-4 text-[#0e141b]">
            ...
            <h2 className="text-[#0e141b] text-lg font-bold leading-tight tracking-[-0.015em]">EduPath</h2>
          </div>
          <div className="flex flex-1 justify-end gap-8">
            <div className="flex items-center gap-9">
              <Link className="text-[#0e141b] text-sm font-medium leading-normal" to="/">Home</Link>
              <Link className="text-[#0e141b] text-sm font-medium leading-normal" to="/programs">Programs</Link>
              <Link className="text-[#0e141b] text-sm font-medium leading-normal" to="/how-it-works">How It Works</Link>
              <Link className="text-[#0e141b] text-sm font-medium leading-normal" to="/about">About</Link>
              <Link className="text-[#0e141b] text-sm font-medium leading-normal" to="/contact">Contact</Link>
            </div>
